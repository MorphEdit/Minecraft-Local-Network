...
set javapath="C:\Program Files\Eclipse Adoptium\jdk-21.0.9.10-hotspot\bin\java.exe"
...
echo -----------------------
echo %javapath% %finaljavaargs% -jar paper-1.21.4-232.jar --nogui %launchargs%
echo.
%javapath% %finaljavaargs% -jar paper-1.21.4-232.jar --nogui %launchargs%
PAUSE
